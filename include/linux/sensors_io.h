...
#define GSENSOR_IOCTL_GET_STATUS				_IOR(GSENSOR, 0x09, int)

//                                                               
#define GSENSOR_IOCTL_SET_ENABLE            _IOW(GSENSOR, 0x0a, int)
//                          
...
#define ECS_IOCTL_SET_YPR              _IOW(MSENSOR, 0x29, int[26])
#define ECS_IOCTL_GET_DELAY             _IOR(MSENSOR, 0x30, int64_t[3])
#define	ECS_IOCTL_GET_LAYOUT			_IOR(MSENSOR, 0x31, char)
...
//                                                               
#define ALPSIO_AD_GET_ACTIVATE			_IOR(MSENSOR, 0x32, int)
//                          
...
#define ALSPS_GET_CALI                        _IOR(ALSPS, 0x09, int)
#define ALSPS_SET_CALI                        _IOW(ALSPS, 0x0a, int)
#define ALSPS_GET_DEVICEID                    _IOR(ALSPS, 0x0b, int)
/*-------------------yucong add-------------------------------------------*/
...
//                                                                    
#define ALSPS_GET_DEVICEID					_IOR(ALSPS, 0x14, int)
//                          
